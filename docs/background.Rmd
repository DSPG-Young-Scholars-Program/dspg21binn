...
* need some comments about how things changed for the two publishers charts
* need some comments about the example data 
...
# **The Data**   
## Data Source: DowJones News and Analytics (DNA)  
...
These figures above describe the 2017 data by providing counts of the top ten publishers and the the top ten companies mentioned in the 2017 Software Articles. 
